# -*- coding: utf-8 -*-
"""
Created on Mon Jul 16 23:06:02 2018
...
k1 = int(k1)
def flsc_code(data, lab, k2, k3, k4):
    clss = np.unique(lab)
    dim = data.shape[0]
    ...
    f = tr_data.dot(W)
    return f,W
tr_data_flsc, red_fac = flsc_code(tr_data,tr_lab,neighlab,neighdt,k1)
...
acc = svmclassifier(tr_data_flsc,tr_lab,te_data_flsc,te_lab)
